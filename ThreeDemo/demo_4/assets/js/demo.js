var DEMO = {
  ...
  initialize: function initialize (inIdCanvas) {
    ...
    this.ms_Scene.fog = new THREE.FogExp2( 0xFFFFFF, 0.00005 )
      ...
      for (let j = -2; j <= 2; ++j ) {
        for (let k = -2; k <= 2; ++k ) {
          ...
          var material = new THREE.MeshLambertMaterial({
            fog: true,
            side: THREE.DoubleSide,
            color: new THREE.Color( 0.5 + i * 0.2, 0.5 + j * 0.2, 0.5 + k * 0.2)
          })
  ...
  loadSkyBox: function loadSkyBox () {
    var aCubeMap = THREE.ImageUtils.loadTextureCube([
      '../demo_1/assets/img/px.jpg',
		  '../demo_1/assets/img/nx.jpg',
		  '../demo_1/assets/img/py.jpg',
		  '../demo_1/assets/img/ny.jpg',
		  '../demo_1/assets/img/pz.jpg',
		  '../demo_1/assets/img/nz.jpg'
    ]);
